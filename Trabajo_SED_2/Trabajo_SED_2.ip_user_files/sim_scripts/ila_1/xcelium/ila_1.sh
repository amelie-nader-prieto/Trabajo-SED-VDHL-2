...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../Trabajo_SED_2.gen/sources_1/ip/ila_1/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../Trabajo_SED_2.gen/sources_1/ip/ila_1/hdl/verilog" \
